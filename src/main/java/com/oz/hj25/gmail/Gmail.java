...
public class Gmail {
	...
	private void send() throws AddressException, MessagingException {
		...
		// IMAP(Internet Message Access Protocol)�� ���� ���� ���ͳ� �������� �� �ϳ���, ���� �����κ��� TCP/IP
		// ������ ���� �̸����� �������µ� ���ȴ�.
		// ���� ���� ���� ���� ��������(Simple Mail Transfer Protocol, SMTP)�� ���ͳݿ��� �̸����� ������ ���� �̿�Ǵ�
		// ���������̴�. ����ϴ� TCP ��Ʈ��ȣ�� 25���̴�.
		...
		// true �� ���, auth ����� ����Ͽ� ����ڸ� �����Ͻʽÿ�. �⺻���� false�Դϴ�.
		props.put("mail.smtp.auth", "true");

		// connect () �޼��尡 SMTP ���� ��Ʈ�� ��� ������ �������� ���� ��� ������ SMTP ���� ��Ʈ�Դϴ�. �⺻���� 25�Դϴ�.
		...
		// �����Ǿ��ִ� ���, javax.net.SocketFactory �������̽��� �����ϴ� Ŭ������ �̸��� �����մϴ�. �� Ŭ������ SMTP
		// ������ ����� �� ���˴ϴ�.
		props.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");

		// true�� �����ϸ� ������ ���� ���丮 Ŭ������ ����Ͽ� ������ �ۼ����� ������ java.net.Socket Ŭ������ ����Ͽ� ������
		// �ۼ��ϰԵ˴ϴ�. �⺻���� true�Դϴ�.
		props.put("mail.smtp.socketFactory.fallback", "false");

		// false�� �����ϸ� QUIT ����� �������� ������ ��� �����ϴ�. true (�⺻��)�� �����ϸ� ������ QUIT ��ɿ� ���� ������
		// ��ٸ��ϴ�.
		...
		try {
			...
			// ���� ����
			message.setSubject("안녕하세요 HJ25입니다");
			// �޴� ��� ���� �ּ�
