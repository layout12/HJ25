...
var loginId= "${loginPerson.u_id}";
var loginGrade = "${loginPerson.u_grade}";
</script>
</head>
<body>
<%@include file="header.jsp" %>
	...
	<div id="detailForm">
		<div id="container" style="z-index:1">
			...
			<!-- buttons -->
			<div class="sty_btnFt">
			<c:if test="${loginPerson.u_id == detail.u_id or loginPerson.u_grade =='ADMIN' }">
				<button class="btn btn-primary sty_btnDel" onclick="boardDelete(${detail.b_no})">삭제</button>
				</c:if>
				<c:if test="${loginPerson.u_id == detail.u_id }">
